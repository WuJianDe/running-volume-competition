...
<template>
  ...
  >
    ...
    <template v-else>
      ...
      <div
        v-if="justConnected"
        class="max-w-5xl mx-auto px-5 mb-4 fade-up"
      >
        <div
        ...
        >
          <p class="text-xs font-mono" style="color: #4ADE80">✓ Strava 已成功連結！點擊「同步 Strava 資料」更新成績</p>
          <button
            @click="justConnected = false"
      ...
      <section
        v-if="connectRunnerId"
        class="max-w-5xl mx-auto px-5 mb-6 fade-up"
      >
        <div
